...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "sec.mosca": "Shelf-life exposure (Mosca X+Y>Z)",
        "mosca.x": "Data lifetime (X)",
        "mosca.y": "Migration time (Y)",
        "mosca.z": "Quantum horizon (Z)",
        "mosca.gap": "Shelf-life gap",
        "mosca.years": "yr",
        "mosca.assumed": "Assumed defaults — supply --data-lifetime / "
                         "--migration-years / --threat-years to refine.",
        "sec.readiness": "Readiness overview",
        "sec.migration": "Migration readiness score",
        "migration.intro": "Weighted migration posture: pure PQC counts 100%, "
                           "hybrid/composite 80%, weakened-but-not-quantum-broken "
                           "30%, and classically-broken 0%.",
        "migration.score": "Migration readiness",
        "migration.safe": "Quantum-safe",
        "migration.hybrid": "Hybrid",
        "migration.partial": "Partial",
        "migration.vulnerable": "Vulnerable",
        "migration.band.EXCELLENT": "Excellent",
        "migration.band.GOOD": "Good",
        "migration.band.MODERATE": "Moderate",
        "migration.band.POOR": "Poor",
        "migration.band.CRITICAL": "Critical",
        "sec.exposure": "Exposure register",
        "exposure.intro": "Quantum-vulnerable assets ranked by exposure = "
                          "criticality x data-longevity x migration-feasibility "
                          "(each 1-3). Highest exposure first.",
        "exposure.none": "No quantum-vulnerable assets to prioritise.",
        "exposure.ref": "Asset",
        "exposure.crit": "Criticality",
        "exposure.long": "Longevity",
        "exposure.feas": "Feasibility",
    ...
    "ms": {
        ...
        "sec.mosca": "Pendedahan jangka-hayat (Mosca X+Y>Z)",
        "mosca.x": "Jangka-hayat data (X)",
        "mosca.y": "Masa migrasi (Y)",
        "mosca.z": "Ufuk kuantum (Z)",
        "mosca.gap": "Jurang jangka-hayat",
        "mosca.years": "thn",
        "mosca.assumed": "Andaian lalai — bekalkan --data-lifetime / "
                         "--migration-years / --threat-years untuk memperhalus.",
        "sec.readiness": "Gambaran kesediaan",
        "sec.migration": "Skor kesediaan migrasi",
        "migration.intro": "Postur migrasi berwajaran: PQC tulen 100%, "
                           "hibrid/komposit 80%, dilemahkan-tetapi-belum-dipecah-"
                           "kuantum 30%, dan dipecah secara klasik 0%.",
        "migration.score": "Kesediaan migrasi",
        "migration.safe": "Selamat-kuantum",
        "migration.hybrid": "Hibrid",
        "migration.partial": "Separa",
        "migration.vulnerable": "Terdedah",
        "migration.band.EXCELLENT": "Cemerlang",
        "migration.band.GOOD": "Baik",
        "migration.band.MODERATE": "Sederhana",
        "migration.band.POOR": "Lemah",
        "migration.band.CRITICAL": "Kritikal",
        "sec.exposure": "Daftar pendedahan",
        "exposure.intro": "Aset terdedah-kuantum disusun mengikut pendedahan = "
                          "kritikaliti x jangka-hayat-data x kebolehlaksanaan-migrasi "
                          "(setiap satu 1-3). Pendedahan tertinggi dahulu.",
        "exposure.none": "Tiada aset terdedah-kuantum untuk diutamakan.",
        "exposure.ref": "Aset",
        "exposure.crit": "Kritikaliti",
        "exposure.long": "Jangka-hayat",
        "exposure.feas": "Kebolehlaksanaan",
        "exposure.score": "Pendedahan",
        "exposure.tier": "Tahap",
        "tier.CRITICAL": "Kritikal",
        "tier.HIGH": "Tinggi",
        "tier.MEDIUM": "Sederhana",
        "tier.LOW": "Rendah",
